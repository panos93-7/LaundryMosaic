...
- fabric type: must be exactly one of ["cotton", "synthetics", "wool", "delicate"]
- color: must be exactly one of ["white", "colored", "dark"]
...
- "fabric" must be exactly one of: "cotton", "synthetics", "wool", "delicate".
- "color" must be exactly one of: "white", "colored", "dark".
