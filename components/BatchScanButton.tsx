...
export default function BatchScanButton({ userTier }: Props) {
  const navigation = useNavigation<any>();

  const locked = !isFeatureAvailable("batchScan", userTier);

  function handlePress() {
    withUpsell("batchScan", userTier, navigation, () => {
  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        <Text style={styles.text}>Batch Scan</Text>
      </View>
    </TouchableOpacity>
  );
}
