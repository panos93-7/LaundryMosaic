import { generateStainRemovalTips } from "../SmartScan/aiStainRemoval";
import { stainTipsCache } from "../SmartScan/stainTipsCache";
...
export async function generateStainRemovalTipsCached(stain: string, fabric: string) {
  try {
    // 1) Check cache
    ...
    return []; // ← ALWAYS return safe array
  }
}